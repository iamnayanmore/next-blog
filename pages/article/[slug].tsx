...
const slug = ({ article, notFound = false }: IPropType) => {
  return (
    <>
      <Head>
        <title>{article.attributes.title} | Homepage</title>
      ...
      <div className="my-12 grid lg:grid-cols-3 gap-12">
        ...
        <div className="sticky top-5" style={{ height: "500px" }}>
          ...
          />
          <button className="border-2 border-primary rounded py-1 px-6 text-primary hover:bg-primary hover:text-white transition-all">
            Subscribe
          </button>
